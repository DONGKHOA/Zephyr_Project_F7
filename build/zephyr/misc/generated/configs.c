...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_DEMO_MUSIC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_USE_DEMO_MUSIC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LTDC_DISABLE_FMC_BANK1, 1);
